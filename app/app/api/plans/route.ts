...
export async function POST(req: NextRequest) {
  try {
    ...
    const { title, description, date, theme, isPublic = false, showDriving = true } = body;
    ...
    await sql`
      INSERT INTO plans (id, title, description, date, theme, user_id, is_public, show_driving)
      VALUES (${id}, ${title}, ${description || null}, ${date || null}, ${theme || null}, ${session.user.id}, ${isPublic}, ${showDriving})
    `;
